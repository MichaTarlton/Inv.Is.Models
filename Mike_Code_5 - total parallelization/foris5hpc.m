...
%%%% Parameters
    ...
    %betavec = [0.05]   %betavec value 2
    %betavec = [0.1]    %betavec value 3
    %betavec = [0.2]    %betavec value 4
    %betavec = [0.3]    %betavec value 5
    %betavec = [0.4]    %betavec value 6
    %betavec = [0.5]    %betavec value 7 
    %betavec = [0.6]    %betavec value 8
    %betavec = [0.7]    %betavec value 9
    %betavec = [0.8]    %betavec value 10
    %betavec = [1.0]    %betavec value 11
    %betavec = [1.2]    %betavec value 12
    %betavec = [1.4]    %betavec value 13
    %betavec = [1.6]     %betavec value 14
...
for Ti = 1:length(Tvec)
    ...
    %
                    ...
                    [LLH,statvecs,stats,jta] = PBLLH4(T,N,tp,beta,sprs,h_on,SStruct,JHnorm,jta,jtatot);
