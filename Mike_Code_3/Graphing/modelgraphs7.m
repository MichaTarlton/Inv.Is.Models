% modelgraphs7.m 
% This time the AUROC instead AURPC
...
%          'XColor','k','YColor','k');
		...
		for labels = 1:figwidth
    	    ...
    	    [ax2,h2]=suplabel(['Fallout: $\frac{FP}{FP + TN}$'],'y');

    	    [ax,h3]=suplabel(['Area Under the Reciever-Operator Characteristic (AUROC) for Topology: ',topovec{topology}, ', and Sparsity: ',num2str(sprsvec(St))] ,'t');
			set(h3,'FontSize',30)
