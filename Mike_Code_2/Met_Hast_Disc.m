...
function SstructDisc = Met_Hast_Disc(T,N,jn,JHstruct,sparsity,time,name,beta)
...
for i = 1:jn
	...
	save([name,'\',time(1:5),'SstructDisc_N',num2str(N),'_T1E',num2str(log10(T)),'_trials',num2str(jn),'_beta',num2str(beta),'_sprs',num2str(100*sparsity),'_',time(6:12),'.mat'],'SstructDisc','-v7.3');
	disp(['End Disconnected S run ',num2str(i)])
end
