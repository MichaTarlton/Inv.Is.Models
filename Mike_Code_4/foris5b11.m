...
cd('E:\GitHub\Inv.Is.Models\Mike_Code_4\Warm Storage'); 
...
Tvec = [1e3] % Tvec = [1e3,1e4,1e5,1e6]; %| originally preset to be a multiple of the node number:T.calculation: 3*M(numel(M))
